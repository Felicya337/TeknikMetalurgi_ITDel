<aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #343A40;">
    <!-- Brand Logo -->
    <a href="{{ route('admin.dashboard') }}" class="brand-link d-flex align-items-center p-3"
        style="text-decoration: none;">
        <img src="{{ asset('adminlte/dist/img/AdminLTELogo.png') }}" alt="IT Del Logo" class="brand-image elevation-3"
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!-- Kerjasama -->
            <li class="nav-item">
                <a href="{{ route('admin.collaborate.index') }}"
                    class="nav-link {{ request()->routeIs('admin.collaborate.*') ? 'active' : '' }}">
            ...
            <!-- Meta Profile -->
            <li class="nav-item">
                <a href="{{ route('admin.metaprofile.index') }}"
                    class="nav-link {{ request()->routeIs('admin.metaprofile.*') ? 'active' : '' }}">
            ...
            <li class="nav-item">
                <a href="{{ route('admin.laboratory.index') }}"
                    class="nav-link {{ request()->routeIs('admin.laboratory.*') ? 'active' : '' }}">
            ...
            <!-- Struktur Dosen -->
            <li class="nav-item">
                <a href="{{ route('admin.structure_organization.index') }}"
                    class="nav-link {{ request()->routeIs('admin.structure_organization.*') ? 'active' : '' }}">
            ...
            <!-- Kegiatan Mahasiswa -->
            <li class="nav-item">
                <a href="{{ route('admin.studentactivity.index') }}"
                    class="nav-link {{ request()->routeIs('admin.studentactivity.*') ? 'active' : '' }}">
