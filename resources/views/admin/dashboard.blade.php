        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="data-grid">
                            <a href="{{ route('admin.news.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.testimonial.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.collaborate.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.metaprofile.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.curriculum.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.achievement.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.facility.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.laboratory.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.lecturer.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.structure_organization.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.studentactivity.index') }}" class="data-card"
                            ...
                            <a href="{{ route('admin.student_achievement.index') }}" class="data-card"
                                style="--card-gradient-1: #8b5cf6; --card-gradient-2: #a855f7;">
                                <div class="card-content">
