                            ...
                            <table class="table table-striped table-bordered text-center" id="laboratoryTable">
                                ...
                                <tbody>
                                    @foreach ($laboratories as $laboratory)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($laboratory->images && count($laboratory->images) > 0)
                                                    <img src="{{ asset('storage/' . $laboratory->images[0]) }}"
                                        ...
                                        <div class="modal fade" id="modal-read-laboratory-{{ $laboratory->id }}"
                                            tabindex="-1"
                                            aria-labelledby="modal-read-laboratoryLabel-{{ $laboratory->id }}"
                                            aria-hidden="true">
                                        ...
                                        <div class="modal fade" id="modal-edit-laboratory-{{ $laboratory->id }}"
                                            tabindex="-1"
                                            aria-labelledby="modal-edit-laboratoryLabel-{{ $laboratory->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
    ...
    <div class="modal fade" id="modal-laboratory" tabindex="-1" aria-labelledby="modal-laboratoryLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('admin.laboratory.create')
                </div>
            </div>
        </div>
    </div>
