<form action="{{ route('admin.laboratory.update', $laboratory->id) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="mb-3">
    ...
    <div class="mb-3">
        ...
        <div id="editor-edit-{{ $laboratory->id }}" style="height: 300px;"></div>
        <input type="hidden" id="description-edit-{{ $laboratory->id }}" name="description"
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="academic_hours" name="academic_hours"
            value="{{ old('academic_hours', $laboratory->academic_hours) }}" placeholder="Contoh: 08:00-16:00">
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="collaborative_hours" name="collaborative_hours"
            value="{{ old('collaborative_hours', $laboratory->collaborative_hours) }}"
    ...
    <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1"
            {{ old('is_active', $laboratory->is_active) ? 'checked' : '' }}>
