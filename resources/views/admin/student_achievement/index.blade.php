                            ...
                            <table class="table table-striped table-bordered text-center" id="studentAchievementTable">
                                ...
                                <tbody>
                                    @foreach ($achievements as $achievement)
                                        <tr>
                                            <td class="text-start">{{ $achievement->nama_kegiatan }}</td>
                                            <td>{{ $achievement->waktu_pelaksanaan ? \Carbon\Carbon::parse($achievement->waktu_pelaksanaan)->format('d-m-Y') : '-' }}
                                            </td>
                                            <td>{{ ucfirst($achievement->tingkat ?? '-') }}</td>
                                            <td class="text-start">{{ $achievement->prestasi_yang_dicapai ?? '-' }}</td>
                                            <td>
                                                <span
                                        ...
                                        <div class="modal fade" id="modal-read-student-achievement-{{ $achievement->id }}"
                                            tabindex="-1"
                                            aria-labelledby="modal-read-student-achievementLabel-{{ $achievement->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Detail Prestasi:
                                                            {{ $achievement->nama_kegiatan }}</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                            aria-label="Close"></button>
                                                    </div>
                                                    <div class="modal-body">
                                                        @include('admin.student_achievement.read', [
                                        ...
                                        <div class="modal fade" id="modal-edit-student-achievement-{{ $achievement->id }}"
                                            tabindex="-1"
                                            aria-labelledby="modal-edit-student-achievementLabel-{{ $achievement->id }}"
                                            aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                    ...
                                                    <div class="modal-body">
                                                        @include('admin.student_achievement.edit', [
                                                            'achievement' => $achievement,
                                                        ])
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="modal-student-achievement" tabindex="-1" aria-labelledby="modal-student-achievementLabel"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('admin.student_achievement.create')
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            @if ($errors->any())
                ...
                @if (old('form_type') == 'create_student_achievement')
                    $('#modal-student-achievement').modal('show');
                @endif

                @if (old('form_type') == 'edit_student_achievement')
