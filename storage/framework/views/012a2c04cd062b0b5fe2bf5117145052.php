<form action="<?php echo e(route('admin.student_achievement.update', $achievement->id)); ?>" method="POST">
    <?php echo csrf_field(); ?>
    <?php echo method_field('PUT'); ?>
    <input type="hidden" name="form_type" value="edit_student_achievement">
    <input type="hidden" name="achievement_id_error" value="<?php echo e($achievement->id); ?>">
    <div class="mb-3">
        <label for="nama_kegiatan" class="form-label">Nama Kegiatan</label>
        <input type="text" class="form-control" id="nama_kegiatan" name="nama_kegiatan"
            value="<?php echo e(old('nama_kegiatan', $achievement->nama_kegiatan)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="date" class="form-control" id="waktu_pelaksanaan" name="waktu_pelaksanaan"
            value="<?php echo e(old('waktu_pelaksanaan', $achievement->waktu_pelaksanaan ? $achievement->waktu_pelaksanaan->format('Y-m-d') : '')); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="tingkat" name="tingkat"
            value="<?php echo e(old('tingkat', $achievement->tingkat)); ?>"
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="prestasi_yang_dicapai" name="prestasi_yang_dicapai"
            value="<?php echo e(old('prestasi_yang_dicapai', $achievement->prestasi_yang_dicapai)); ?>">
...
<?php /**PATH C:\xampp\htdocs\MetalurgiITDEL\resources\views/admin/student_achievement/edit.blade.php ENDPATH**/ ?>