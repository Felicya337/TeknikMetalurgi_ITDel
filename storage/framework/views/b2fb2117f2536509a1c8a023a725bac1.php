    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <ul>
                ...
                <?php endif; ?>
                <li><strong>Isi:</strong> <?php echo nl2br(e($inquiry->content)); ?></li>
            </ul>
            <h3>Tanggapan Admin:</h3>
            <p><?php echo $inquiry->admin_response ? nl2br(e($inquiry->admin_response)) : 'Belum ada tanggapan dari admin.'; ?></p>
...
<?php /**PATH C:\xampp\htdocs\MetalurgiITDEL\resources\views/emails/inquiry-response.blade.php ENDPATH**/ ?>