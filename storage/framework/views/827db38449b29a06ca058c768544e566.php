        ...
        <div class="mt-5 mb-5" id="cardLayout" style="display: none;">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="row no-gutters align-items-center">
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('aset/img/prestasi1.jpg')); ?>" class="img-fluid p-3" alt="Prestasi Cumlaude">
                    </div>
                    <div class="col-md-8">
                        <div class="card-body">
            ...
            <div class="card mb-4 shadow-sm">
                <div class="row no-gutters align-items-center">
                    <div class="col-md-4">
                        <img src="<?php echo e(asset('aset/img/prestasi2.jpg')); ?>" class="img-fluid p-3"
