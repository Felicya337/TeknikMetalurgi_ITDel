...
unset($__errorArgs, $__bag); ?>" id="type_edit_<?php echo e($activity->id); ?>"
            name="type" required>
...
unset($__errorArgs, $__bag); ?>"
            id="title_edit_<?php echo e($activity->id); ?>" name="title" value="<?php echo e(old('title', $activity->title)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        <label for="editor-edit-<?php echo e($activity->id); ?>" class="form-label">Deskripsi</label>
...
unset($__errorArgs, $__bag); ?>"
            id="image_edit_<?php echo e($activity->id); ?>" name="image" accept="image/*">
        <?php if($activity->image): ?>
            <div class="mt-2">
                <small>Gambar Saat Ini:</small><br>
                <img src="<?php echo e(asset('storage/' . $activity->image)); ?>" class="img-thumbnail mt-1"
