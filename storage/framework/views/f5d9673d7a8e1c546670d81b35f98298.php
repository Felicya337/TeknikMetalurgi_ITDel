<form action="<?php echo e(route('admin.laboratory.update', $laboratory->id)); ?>" method="POST" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <div id="editor-edit-<?php echo e($laboratory->id); ?>" style="height: 300px;"></div>
        <input type="hidden" id="description-edit-<?php echo e($laboratory->id); ?>" name="description"
            value="<?php echo e(old('description', $laboratory->description)); ?>">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <?php
            $selectedDays = old('academic_days', $laboratory->academic_days ?? []);
            $days = [
                'Monday' => 'Senin',
                'Tuesday' => 'Selasa',
                'Wednesday' => 'Rabu',
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="academic_hours" name="academic_hours"
            value="<?php echo e(old('academic_hours', $laboratory->academic_hours)); ?>" placeholder="Contoh: 08:00-16:00">
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="collaborative_hours" name="collaborative_hours"
            value="<?php echo e(old('collaborative_hours', $laboratory->collaborative_hours)); ?>"
            ...
            <div class="mt-2">
                ...
                <?php $__currentLoopData = $laboratory->images; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <img src="<?php echo e(asset('storage/' . $image)); ?>" class="img-thumbnail"
                        style="max-width: 100px; margin-right: 10px;" alt="Laboratory Image">
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </div>
        <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3 form-check">
        <input type="checkbox" class="form-check-input" id="is_active" name="is_active" value="1"
            <?php echo e(old('is_active', $laboratory->is_active) ? 'checked' : ''); ?>>
...
<?php /**PATH C:\xampp\htdocs\MetalurgiITDEL\resources\views/admin/laboratory/edit.blade.php ENDPATH**/ ?>