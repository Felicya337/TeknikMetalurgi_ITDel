...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" id="student" name="student" value="<?php echo e(old('student')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="mb-3">
        ...
        <input type="hidden" id="content-create" name="content" value="<?php echo e(old('content')); ?>">
