...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'AdminTM | Dashboard'); ?></title>

    <!-- Preload Critical Resources -->
    <link rel="preload" href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,400i,700" as="style">
    <link rel="preload" href="<?php echo e(asset('adminlte/plugins/fontawesome-free/css/all.min.css')); ?>" as="style">
    <link rel="preload" href="<?php echo e(asset('adminlte/dist/css/adminlte.min.css')); ?>" as="style">
...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="preloader flex-column justify-content-center align-items-center">
            <img class="animation__shake" src="<?php echo e(asset('adminlte/dist/img/AdminLTELogo.png')); ?>" alt="AdminLTELogo"
                height="60" width="60">
        </div>
...
<?php /**PATH C:\xampp\htdocs\MetalurgiITDEL\resources\views/layouts/app.blade.php ENDPATH**/ ?>