<?php $__env->startSection('content'); ?>
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $structures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $structure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr data-structure-id="<?php echo e($structure->id); ?>">
                                            ...
                                            <td>
                                                <span
                                                    class="badge status-badge <?php echo e($structure->is_active ? 'bg-success' : 'bg-danger'); ?>"
                                                    data-status="<?php echo e($structure->is_active ? '1' : '0'); ?>">
                                                    <?php echo e($structure->is_active ? 'Aktif' : 'Tidak Aktif'); ?>

                                                </span>
                                            </td>
                                            <td>
                                                <?php if($structure->image): ?>
                                                    <img src="<?php echo e(asset('storage/' . $structure->image)); ?>"
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-info btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modal-read-structure-<?php echo e($structure->id); ?>">
                                                    <i class="fas fa-eye"></i> Lihat
                                                </button>
                                                <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal"
                                                    data-bs-target="#modal-edit-structure-<?php echo e($structure->id); ?>">
                                                    <i class="fas fa-edit"></i> Edit
                                                </button>
                                                <form
                                                    action="<?php echo e(route('admin.structure_organization.destroy', $structure->id)); ?>"
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <?php echo $__env->make('admin.structure_organization.create', [
    ...
    <?php $__currentLoopData = $structures; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $structure): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="modal fade" id="modal-read-structure-<?php echo e($structure->id); ?>" tabindex="-1"
            aria-labelledby="modal-read-structureLabel-<?php echo e($structure->id); ?>" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <?php echo $__env->make('admin.structure_organization.read', ['structure' => $structure], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modal-edit-structure-<?php echo e($structure->id); ?>" tabindex="-1"
            aria-labelledby="modal-edit-structureLabel-<?php echo e($structure->id); ?>" aria-hidden="true">
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        <?php echo $__env->make('admin.structure_organization.edit', [
                            'structure' => $structure,
                            'allStructures' => $allStructures,
                            'hasLevelZero' => $hasLevelZero,
                        ], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\MetalurgiITDEL\resources\views/admin/structure_organization/index.blade.php ENDPATH**/ ?>